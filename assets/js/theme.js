;(function($) {
    ...
    $(".portfolio_grid .protfoli_filter li").click(function(){
        $(".owl-carousel.testimonial_slide").removeClass('hidden');
    });
    $(".post").click(function(){
        $(this).toggleClass('border');
    });

    // $(".selection-group button ").click(function () {
    //   $(".selector .dropdown-menu").toggleClass("active");
    // }).focusout(function(){
    //     $(".selector .dropdown-menu").removeClass("active");
    // });
